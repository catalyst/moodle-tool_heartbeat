[![ci](https://github.com/catalyst/moodle-tool_heartbeat/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/catalyst/moodle-tool_heartbeat/actions/workflows/ci.yml?branch=master)
